...
> = {
  ...
  liquidity: { base: "#22d3ee", muted: "#67e8f9", faint: "#cffafe" },
  growth: { base: "#14b8a6", muted: "#5eead4", faint: "#ccfbf1" },
  ...
  healthcare: { base: "#38bdf8", muted: "#7dd3fc", faint: "#e0f2fe" },
  realestate: { base: "#a855f7", muted: "#d8b4fe", faint: "#f3e8ff" },
  communications: { base: "#e879f9", muted: "#f5d0fe", faint: "#fae8ff" },
  crypto: { base: "#8b5cf6", muted: "#c4b5fd", faint: "#ede9fe" },
  metals: { base: "#d97706", muted: "#fbbf24", faint: "#fef3c7" },
