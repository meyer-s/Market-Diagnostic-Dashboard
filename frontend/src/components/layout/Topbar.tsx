...
export default function Topbar() {
  ...
  const { focusAll, toggleFocusAll } = useFocusMode();
  ...
  const focusButtonClass = focusAll
    ? "bg-stealth-700 text-pulse-300"
      ...
      <div className="flex items-center justify-between h-16 px-4 md:px-6">
        ...
        <div className="hidden lg:flex items-center gap-2">
          ...
          <button
            ...
            className={`px-3 py-2 rounded-lg text-xs font-semibold tracking-wide uppercase transition-colors ${focusButtonClass}`}
            aria-pressed={focusAll}
            title="Focus all cards"
          >
            Focus All
          </button>
        </div>
        ...
        <div className="flex items-center gap-2 lg:hidden">
          ...
          <button
            ...
            className="p-2 text-stealth-300 hover:text-stealth-100 hover:bg-stealth-700 rounded-lg transition-colors"
      ...
      {mobileMenuOpen && (
        <nav className="lg:hidden bg-stealth-850 border-t border-stealth-700">
          <button
            ...
            className={`w-full text-left px-4 py-3 text-xs font-semibold tracking-wide uppercase transition-colors border-b border-stealth-700 ${focusButtonClass}`}
            aria-pressed={focusAll}
          >
            Focus All
          </button>
