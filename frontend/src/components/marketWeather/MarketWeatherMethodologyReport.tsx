            ...
            >
              <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
                ...
                <MethodBlock title="Pair reading hierarchy">
                  Overview presents the deterministic description, relative progress, current beta-adjusted chain, exact field-separation classification, notable own-history-relative gaps, and compact support status. Field detail contains basis and subject controls, relationship scopes, and the 15-coordinate explorer. Audit receipt contains exact window/support/compatibility disclosures, calculation identities, authority, and export controls. This changes disclosure order, not the Pair calculation.
                </MethodBlock>
                <MethodBlock title="Live recipe versus frozen receipt">
                  Pair URLs preserve target, comparator, timeframe, requested history, recipe, basis, displayed subject, selected coordinate, active tab, scope trail and scale, and coordinate ordering. They rerun against then-current provider/cache data and do not preserve the hover date, mobile-scope selection, response values, or summary wording. Export current receipt preserves a compact, unkeyed calculation checksum over shared keys and latest evidence—not full chart histories, a digital signature, or a provider attestation.
                </MethodBlock>
