            ...
            >
              <div className="grid gap-3 lg:grid-cols-2">
                ...
                <MethodBlock title="Secret Options field challenger">
                  Scanner hits and position assessments can carry a compact, immutable <span className="font-mono">option_market_field_v1</span> snapshot made only from completed OHLCV bars. v1.1 snapshots retain their stored revision and compatibility aliases. New v1.2 snapshots add canonical minimum-input and initialization-target coverage plus the nonnegative scaling-quality contract, while preserving alignment assumptions, explicit authority, and the unchanged v1 field vector. They deliberately exclude learned Form IDs, forward outcomes, the relationship atlas, and the circular current-options context shown on this page.
                </MethodBlock>
