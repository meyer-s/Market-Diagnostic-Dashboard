...
_PAGE_INPUTS: List[Dict[str, Any]] = [
    {
        ...
        "metadata": {
            ...
            "relevance": "Agriculture reacts early to growth, inflation, weather, and input-cost shifts, so it adds a real-economy layer to the system overview.",
            ...
            "scoring": "Higher is better. This input uses the agriculture page stability score directly and adds it to the main system composite with a light additive weight.",
    ...
    },
    {
        ...
        "metadata": {
            ...
            "scoring": "Higher is better. This input uses the energy page composite score directly and adds it to the main system composite as a separate overview input.",
            "typical_range": "Above 70 is stable, 40 to 69 is mixed, and below 40 is stressed.",
        },
    },
    {
        ...
        "metadata": {
            ...
            "scoring": "Higher is better. This input converts the real-estate page pressure composite to stability using 100 minus pressure before adding it to the system overview.",
            "typical_range": "Above 70 is stable, 40 to 69 is mixed, and below 40 is stressed.",
        },
    },
]
